...
class NeoGrepCommand(Command):
    ...
    def process(
        ...
        if not pattern:
            ...
            raise RuntimeError("Pattern argument is required")
        ...
        try:
            ...
            raise RuntimeError(f"Context must be a valid integer: {str(e)}")
        ...
        try:
            ...
            if process.returncode == 0:
                ...
                case_info = (
                    " (case-insensitive)" if args.get("ignore_case", False) else ""
                )
